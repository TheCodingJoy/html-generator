$(function(){
	...
	var templateProto = function(){
		...
		this.metaToText = function(){
			...
			metaText += ((this.head.meta.gentag)?'    <meta name="generator" content="http://thecodingjoy.github.io/htmlgenerator/">\n':'');
				...
				case 'page-template':
					switch(this.body.templateId.replace('page-template-','')){
						...
						case 'min':
							...
							bodyTemplateText += '    <p>This is an empty page generated by <a href="https://thecodingjoy.github.io/html-generator/">HTML5 Template Generator</a>.</p>\n';
							break;
						case 'sample':
